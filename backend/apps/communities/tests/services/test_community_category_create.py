...
from apps.communities.models import CommunityTags
...
class CommunityCategoryCreateTests(TestCase):
    def test_community_category_create(self):
        ...
        self.assertEqual(CommunityTags.objects.count(), 1)
        self.assertEqual(CommunityTags.objects.first(), community_category)
