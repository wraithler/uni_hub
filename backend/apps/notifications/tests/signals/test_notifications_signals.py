...
class TestNotificationSignals(unittest.TestCase):
    def setUp(self):
        ...
        self.notification_create_mock = patch('apps.notifications.signals.notification_create').start()
    ...
    def test_handle_post_created_signal(self):
        ...
        self.assertIn(f"{self.post.created_by.first_name} {self.post.created_by.last_name}", kwargs['message'])
    ...
    def test_handle_comment_created_signal(self):
        ...
        self.assertIn(f"{self.comment.created_by.first_name} {self.comment.created_by.last_name}", kwargs['message'])
    ...
    def test_handle_like_created_signal(self):
        ...
        self.assertIn(f"{self.like.user.first_name} {self.like.user.last_name}", kwargs['message'])
