...
class UserNotificationPreferenceTestCase(TestCase):
    def test_filter_by_subscribed_communities_direct(self):
        ...
        community1 = Community.objects.create(name="Community1", created_by=user, category=category)
        community2 = Community.objects.create(name="Community2", created_by=user, category=category)
