...
class Report(BaseModel):
    ...
    reported_by = models.ForeignKey(
        "users.BaseUser", on_delete=models.CASCADE, related_name="submitted_reports"
    )
    ...
    def can_be_modified(self, user):
        return (
            ...
            or (self.community and self.community.is_moderator(user))
            or (self.community and self.community.is_admin(user))
        )
