...
class ReportCategoryUpdateTests(TestCase):
    ...
    def test_report_category_update_success(self):
        category = ReportCategoryFactory.create(name="Bug Report", description="Reports bugs", is_active=True)
        updated_category = report_category_update(
            report_category=category, 
            data={"name": "Feature Request", "description": "Requesting new features", "is_active": False}
        )
