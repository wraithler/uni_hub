...
const mockdata = {
    "posts": [
        ...
        },
        {
            ...
            "content": "Believe outside include those free wall. Environment most sister miss word detail interest. Popular special resource subject wife agency science.",
        ...
        },
        {
            ...
            "content": "Thought power those model kitchen record themselves. Social subject between maybe kitchen. Church money approach peace. Off all lay last keep their figure experience.",
        ...
        },
        {
            ...
            "content": "Drug by simply gas beyond size. Public security personal enjoy measure ground staff suddenly.\nCatch safe manager letter.\nCity much among final act I window. Bank work evidence yet huge TV.",
        ...
        },
        {
            ...
            "content": "Follow boy market medical rather they. Girl case sell near magazine. Common feel write wind.",
        ...
        },
        {
            ...
            "content": "Party nothing central. Think his moment mouth eat you. Agreement he may investment generation analysis.\nOption station discuss score center work. Understand large should gun different practice type.",
    ...
    "events": [
        {
            ...
            "description": "Stage under show specific herself series. Likely trade matter may fly thought. Director measure statement follow serve hundred sea.",
        ...
        },
        {
            ...
            "description": "Beyond process own skin two degree. Environmental some word off president example. Million provide anyone yet me not wrong long.",
        ...
        },
        {
            ...
            "description": "Deep window dream onto. Seven throw husband hold option special. Young suggest outside student realize.",
        ...
        },
        {
            ...
            "description": "Various store service hospital place peace whom. Live against occur tonight television former. Company time always energy.",
        ...
        },
        {
            ...
            "description": "Significant indicate up skin school himself. Animal lawyer success young more. Myself dream cost lose carry across.",
                    ...
                    <Card withBorder radius="md" p="md">
                        ...
                        <Card.Section p="sm">
                            <Group justify="apart">
                                ...
                                <Group gap="sm">
                                    <IconHeart size={20}/>
                                    <Text size="sm" opacity={0.6}>{post.likes_count} Likes</Text>
                                </Group>

                                <Group gap="sm">
                                    <IconMessageCircle size={20}/>
                                    <Text size="sm" opacity={0.6}>{post.comments_count} Comments</Text>
                                </Group>
                            </Group>
                        </Card.Section>
