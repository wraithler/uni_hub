    ...
    <Layout>
      ...
      <main className="container px-4 mx-auto pt-16 md:pt-20 pb-12">
        ...
        <div className="md:hidden mb-6">
          ...
          <h1 className="text-2xl font-bold">Computer Science Society</h1>
        </div>
        ...
        <Card className="mb-8">
          <CardContent className="p-6">
            <p className="text-muted-foreground mb-4">
              The Computer Science Society is a student-led organization
              dedicated to fostering a vibrant community of computer science
              enthusiasts. We organize workshops, hackathons, and networking
              events to help members develop technical skills, explore career
              opportunities, and connect with industry professionals.
            </p>
